...
<html lang="en">
    <head>
        <meta name="description" content="La liste des commandes par periode.">

        <title>Epencia - Commandes / liste par periode</title>
    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-th-list"></i> Liste des commandes par periode</h1>

                </div>
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                    <li class="breadcrumb-item">Commande</li>
                    <li class="breadcrumb-item Actif"><a href="#">Liste par periode</a></li>
                </ul>
            </div>
            <form action="http://localhost:81/20hectares.com/search/commande/liste_commande_periode" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        <div class="tile">
                            ...
                            <center>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="sai_date_debut" class="form-control" type="date">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="control-label">Date fin</label>
                                        <input name="sai_date_fin" class="form-control" type="date">
                                    </div>

                                    <div class="form-group col-md-4 align-self-end">
                                        <button name="btn_rechercher" class="btn btn-primary"><i class="fa fa-fw fa-lg fa-check-circle"></i>Rechercher</button>
                                    </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
                        ...
                        <form action="http://localhost:81/20hectares.com/search/commande/liste_commande_periode" method="POST">
