...
<html lang="en">
  <head>
    <meta name="description" content="La liste des documents par extensions.">
    
    <title>20Hectares - Document / Extensions</title>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Liste des documents par extensions</h1>
          
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Document</li>
          <li class="breadcrumb-item Actif"><a href="#">Liste par extension</a></li>
        </ul>
      </div>
      <form action="http://localhost:81/20hectares.com/search/document/liste_documents_extension" method="POST" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
             <center>
              <div class="row">
                        ...
                        <option value=".doc">Fichiers Word</option>
                        <option value=".xls">Fichiers Excel</option>
                        <option value="png,jpg,jpeg,bmp">Fichiers Image</option>
