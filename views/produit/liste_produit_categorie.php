...
<html lang="en">
    <head>
        ...
        <title>20Hectares - Produit / Liste par categorie</title>
    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-th-list"></i> Liste des produits par categorie</h1>

                </div>
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                    <li class="breadcrumb-item">Produit</li>
                    <li class="breadcrumb-item Actif"><a href="#">Liste par categorie</a></li>
                </ul>
            </div>
            <form action="http://localhost:81/20hectares.com/search/produit/categorie" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        <div class="tile">
                            <center>
                                <div class="row">
                                    <div class="col-lg-12"> 
                                        <div class="form-group">
                                            <table>
                                                <tr>
                                                    <td>Selectionnez la categorie : </td>
                                                    <td><select name="sai_rechercher" class="form-control">
                           ...
                           <div class="table-responsive">
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>
                                        <?php
                                        if (!empty($cateproduits)) {
                                            foreach ($cateproduits as $key => $value) {
                                                ?>
                                                <tr>
