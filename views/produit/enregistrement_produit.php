            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form enctype="multipart/form-data" action="http://localhost:81/20hectares.com/search/produit/enregistrement" method="POST">
                        ...
                        <?php if (!$btnrech) { ?>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <center>
                                        <div class="col-md-6" id="addRowBtn">
                                            <div class="form-group">
                                                <label>Selectionner les images :</label>
