...
//verifier si le login n'existe pas deja
        ...
        $req = $this->con->prepare('INSERT INTO utilisateur SET situation_matrimoniale=:sit,nombre_enfant=:nbre_enf,quartier=:quartier,ville=:ville,nationalite=:nat,sexe=:sexe,lieu_naissance=:lieu_naiss,date_naissance=:dte_naiss,login=:log, nom_prenom=:nom, email=:mail, mdp=:mdp, telephone=:tel, role=:role, matricule=:mat,date_creation=:date_creation,etat=:etat');
        $req->bindParam(':log', $this->login);
        $req->bindParam(':nom', $this->nom_prenom);
    ...
    public function rechercherclient($mat) {
        $req = $this->con->prepare('SELECT * FROM utilisateur WHERE matricule=:mat');
        $req->bindParam(':mat', $mat);
        $req->execute();
        $data = $req->fetchAll();
        return $data;
...
public function inscriptionUtilisateur() {
        ...
        $req->bindParam(':mail', $this->email);
        $req->bindParam(':mdp', $this->telephone);
        $req->bindParam(':tel', $this->telephone);
        $req->bindParam(':role', $this->role);
        $req->bindParam(':mat', $this->matricule);
        $req->bindParam(':date_creation', $this->date_creation);
    ...
    public function listeclient() {
        $req = $this->con->prepare('SELECT * FROM utilisateur where role="client"');
        $req->execute();
        $l = $req->fetchAll();
        return $l;
    }
    ...
    public function nbrestagiaire() {
        $req = $this->con->prepare('SELECT COUNT(*) AS nb FROM utilisateur WHERE role="stagiaire" ');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    }
    ...
    public function nbrerapport() {
        $req = $this->con->prepare('SELECT COUNT(*) AS nb FROM document WHERE categorie_document="rapport de stage" ');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    }

    public function nbretheme() {
        $req = $this->con->prepare('SELECT COUNT(*) AS nb FROM theme_stage');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    }

    public function nbredoc() {
        $req = $this->con->prepare('SELECT COUNT(*) AS nb FROM document WHERE categorie_document!="rapport de stage" ');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    ...
    public function totalRetrait() {
        $req = $this->con->prepare('SELECT SUM(montant_transaction) AS som FROM transaction WHERE type_transaction="Retrait" ');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    }
    ...
    public function totalDepot() {
        $req = $this->con->prepare('SELECT SUM(montant_transaction) AS som FROM transaction WHERE type_transaction="Depot" ');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    }

      public function totalTransfert() {
        $req = $this->con->prepare('SELECT SUM(montant_transaction) AS som FROM transaction WHERE type_transaction="Transfert" ');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    }
     ...
     public function totalNotification() {
        $req = $this->con->prepare('SELECT COUNT(id) AS som FROM notifications');
        $req->execute();
        $sol = $req->fetchAll();
        return $sol;
    }
